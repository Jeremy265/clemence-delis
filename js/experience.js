...
const experiences = [
  new Experience(
    ...
    [
      ...
      "Aide à l'élaboration d'un projet professionnel ou de formation",
    ],
  ),
  new Experience(
    "2018",
    "Titre professionnel - Psychologue du travail",
    "CNAM, Lyon",
    ["Mémoire: accompagner le développement d'un collectif de soignant"],
  ),
  new Experience(
    "2017 - 2018",
    "Stage de Fin d'étude-Psychologue du travail",
    "EHPAD, Lyon",
    [
  ...
  new Experience(
    "2013 - 2016",
    "Animatrice de Groupes d'Analyse de la Pratique",
    "Relais d'Assistante Maternelle 1, 2, 3 Soleil, Lyon",
    [
  ...
  new Experience(
    "2011",
    "Formation au coaching des professionnels",
    "Cap Réussite, Lyon",
    [
  ...
  new Experience(
    "2008",
    "Formation gouvernante en hôtellerie",
    "AFPA, Saint Priest",
    [],
  ),
  new Experience(
    "2006 - 2011",
    "Assistance gouvernante",
    "Hôtel Cité Internationale, Lyon",
    [],
  ),
  new Experience(
    "2003",
  ...
  new Experience(
    "2000 - 2003",
    "Stage de Maîtrise - Psychologue Clinicienne",
    "HCL Service Pédiatrique, Lyon",
    [
